...
func TestParseConfigAddArgsWithMissingFileSources(t *testing.T) {
	...
	_, _, _, err := parseConfigAddArgs([]string{"doc_test_1"})
...
func TestParseConfigAddArgsWithFile(t *testing.T) {
	...
	doc, docCat, sources, err := parseConfigAddArgs([]string{"doc_test_1", "source_test_1,source_test_2"})
	...
	assert.Equal(t, []string{"source_test_1", "source_test_2"}, sources, "Must return sources file path")
}
...
func TestParseConfigAddArgsWithURL(t *testing.T) {
	...
	doc, docCat, sources, err := parseConfigAddArgs([]string{"http://google.com", "source_test_1,source_test_2"})
